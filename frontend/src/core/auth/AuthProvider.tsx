...
export interface AuthContextType {
  ...
  isLoading: boolean;
  /** True if user has admin role (not super) */
  isAdmin: boolean;
  /** True if user has super admin role */
  isSuper: boolean;
  /** True if user has admin or super role */
...
export function AuthProvider({ children, initialUser }: AuthProviderProps) {
  ...
  const isSuper = user?.system_role === "super";
  const isPrivileged = isAdmin || isSuper;
