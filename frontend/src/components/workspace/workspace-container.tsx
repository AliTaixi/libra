      ...
      <div className="flex items-center gap-2 px-4">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            {segments?.[1] && nameOfSegment(segments[1], t) && (
              <>
...
function nameOfSegment(
  ...
  // writing 和 knowledge-base 页面隐藏面包屑第二级
  if (segment === "writing") return "";
  if (segment === "knowledge-base") return "";
  if (segment === "drawio") return "";
