...
import { FileManagementSettingsPage } from "@/components/workspace/settings/file-management-settings-page";
...
export function SettingsDialog(props: SettingsDialogProps) {
  ...
  const sections = useMemo(
    () => {
      const list: { id: SettingsSection; label: string; icon: typeof UserIcon }[] = [
        {
          id: "account",
        ...
        {
          id: "files",
          label: t.settings.sections.files,
          icon: FileIcon,
        },
        ...
        <div className="grid min-h-0 flex-1 gap-4 md:grid-cols-[220px_minmax(0,1fr)]">
          ...
          <ScrollArea className="h-full min-h-0 rounded-lg border">
            <div className="space-y-8 p-6">
              ...
              {activeSection === "files" && <FileManagementSettingsPage />}
              {activeSection === "models" && isSuper && <ModelsSettingsPage />}
