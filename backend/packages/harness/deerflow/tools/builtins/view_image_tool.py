...
from deerflow.sandbox.tools import get_allowed_read_paths
from deerflow.tools.types import Runtime

_ALLOWED_IMAGE_VIRTUAL_ROOTS = (VIRTUAL_PATH_PREFIX,)
_ALLOWED_IMAGE_VIRTUAL_ROOTS_TEXT = VIRTUAL_PATH_PREFIX
...
def view_image_tool(
    ...
    try:
        validate_local_tool_path(image_path, thread_data, read_only=True, allowed_read_paths=allowed_read_paths)
