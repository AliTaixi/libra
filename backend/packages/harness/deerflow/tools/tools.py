...
# Agent and skill management tools (always available, restricted to specific directories)
AGENT_MGMT_TOOLS: list[BaseTool] = []


def _get_agent_mgmt_tools() -> list[BaseTool]:
    """Lazy-load agent and skill management tools."""
    global AGENT_MGMT_TOOLS
    if not AGENT_MGMT_TOOLS:
        from deerflow.tools.agent_manage_tool import agent_manage_tool
        from deerflow.tools.skill_manage_tool import skill_manage_tool

        AGENT_MGMT_TOOLS = [agent_manage_tool, skill_manage_tool]
    return AGENT_MGMT_TOOLS
...
def get_available_tools(
    ...
    *,
    ...
    # Add agent and skill management tools (always available, directory-restricted)
    agent_mgmt_tools = _get_agent_mgmt_tools()
    builtin_tools.extend(agent_mgmt_tools)
