...
async def get_artifact(thread_id: str, path: str, request: Request, download: bool = False) -> Response:
    ...
    Args:
        ...
        path: The artifact path with virtual prefix (e.g., mnt/user-data/file.txt).
    ...
    Example:
        - Get text file inline: `/api/threads/abc123/artifacts/mnt/user-data/notes.txt`
        - Download file: `/api/threads/abc123/artifacts/mnt/user-data/data.csv?download=true`
    ...
    if ".skill/" in path:
        ...
        skill_file_path = path[: marker_pos + len(".skill")]  # e.g., "mnt/user-data/my-skill.skill"
