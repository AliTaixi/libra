...
class LocalAuthProvider(AuthProvider):
    ...
    async def has_privileged_users(self) -> bool:
        """Return True if any admin or super user exists."""
        return await self._repo.has_privileged_users()

    async def count_super_admin_users(self) -> int:
        """Return number of super admin users."""
        return await self._repo.count_super_admin_users()
